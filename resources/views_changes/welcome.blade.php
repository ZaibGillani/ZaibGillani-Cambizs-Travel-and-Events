		...
		@include('includes.header')
         <main class="main-content">
            ...
            <section class="home-banner">
               <img src="{{ url('/img/banner/banner.jpg') }}" alt="home-banner" class="d-none d-sm-block">
                  ...
                  <div class="tab-content p-4" id="pills-tabContent">
                     <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <ul class="nav nav-pills mb-3 child-tab justify-content-center align-items-center" id="pills-tab" role="tablist">
                           ...
                           <li class="nav-item" role="presentation">
                              <button class="nav-link" id="pills-bus-tab" data-bs-toggle="pill" data-bs-target="#pills-bus" type="button" role="tab" aria-controls="pills-bus" aria-selected="false"><img src="/img/icons/bus.png" alt=""><span>Bus</span></button>
                           </li>
                           <li class="nav-item" role="presentation">
                              ...
                              <div class="swiper-wrapper feature-event-slider">
                                 <div class="swiper-slide feature-event-item">
                                    <div class="inner-content">
                                       <div class="thumb">
                                          <a href="events.html"> <img src="{{ url('/img/home-photos/event-img.jpg')}}"></a>
                                       </div>
