               ...
               <div class="panel panel-default credit-card-box">
                  <div class="panel-body">
                     ...
                     <form
						...
						<input type="hidden" name="ticket_total_price_c" value="{{$ticket_total_price}}" />
                        ...
                        <div class="row">
                           <div class="col-xs-12">
                              <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now (£{{$ticket_total_price}})</button>
                           </div>
                        </div>
                     </form>
                  </div>
