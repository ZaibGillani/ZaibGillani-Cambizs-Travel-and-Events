            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 3em; text-align: center;">
            				<h2>Thanks for booking the tickets.</h2>
            				<p>Your Ticket ID is: <b>{{ $details['order_id'] }}</b></p>
            				<p>Event Name: <b>{{ $details['event_name'] }}</b></p>
            				<div class="icon">
	            				<a href="#">
		        ...
		        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
		          <tr>
		            <td class="bg_white email-section">
					  ...
					  @foreach($details['booking_info_new'] as $key => $info)
						<td valign="top" width="33.333%" style="padding-top: 20px;" class="services">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                          <tr>
                            <td class="icon">
                          ...
                          <tr>
                            <td class="text-services">
                            	<h3>{{$info['ticket_name']}}</h3>
                              <p>{{$info['ticket_price']}}</p>
                              <p>{{$info['ticket_quantity']}}</p>
                            </td>
                          </tr>
                        </table>
                      </td>
