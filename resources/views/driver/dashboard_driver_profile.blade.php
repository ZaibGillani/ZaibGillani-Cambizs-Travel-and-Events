         ...
         <div class="page-wrapper">
            <div class="page-content">
               ...
               <div class="d-flex align-items-center mb-4">
                  <div>
                     <h3 class="mb-0"><i class='bx bxs-car text-orange'></i> Driver Profile</h3>
                  </div>
               </div>
			    @if (session('status'))
			   ...
			   <div class="col-md-7 col-lg-5 px-5">
                  ...
                  <form method="post" id="driver_profile_update" action="{{ route('driver_profile_update') }}" enctype="multipart/form-data">
					@csrf
